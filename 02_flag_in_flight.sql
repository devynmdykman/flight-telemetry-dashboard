...
-- Purpose:
-- Define a conservative, robust "in_flight" flag to separate airborne segments from noise.
...
-- These thresholds are conservative and meant to capture clearly-airborne flight (not taxi).
